 ...
 */
public class HSVLum extends MarvinAbstractImagePlugin {
    ...
    public void process(
		...
		Cr = (int)( 128 + 0.5 * r - 0.418688 * g - 0.081312 * b);
                ...
                int nr = (int) (Y + 1.402*(Cr-128));
                int ng = (int) (Y - 0.34414 * (Cb - 128) - 0.71414 * (Cr - 128));
                int nb = (int) (Y + 1.772 * (Cb - 128));
                
                
                
                imageOut.setIntColor(x, y, r-nr, g-ng, b-nb);
            }
        }
    }
}